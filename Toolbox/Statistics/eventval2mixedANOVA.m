function eventval2mixedANOVA

% This function will output data to excel for repeated measures statistical analysis.
%
% NOTES
% - Data must have been run through eventval.m
% - Data will be outputted in a simple excel format, you can then use sorting
%   functions in excel to tailor the output to your needs
% - Function likely needs updates for specific statistical designs. Use as
%   a starting point. 
