function varargout = director_cameraman(action,varargin)
...
switch action
    ...
    case 'buttondown'
        ...
        set(gcf,'windowbuttonmotionfcn','director_cameraman(''motion'')');
        set(gcf,'windowbuttonupfcn','director_cameraman(''up'')');
        uiwait
        uirestore(state);
        varargout{1} = ismoved;
